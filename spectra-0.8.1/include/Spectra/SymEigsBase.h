...
protected:
    ...
    virtual void sort_ritzpair(int sort_rule)
    {
        ...
        SortEigenvalue<Scalar, LARGEST_ALGE> sorting(m_ritz_val.data(), (int)m_nev);
        std::vector<int> ind = sorting.index();
        ...
        switch(sort_rule)
        {
            ...
            case LARGEST_MAGN:
            {
                SortEigenvalue<Scalar, LARGEST_MAGN> sorting(m_ritz_val.data(), (int)m_nev);
                ind = sorting.index();
            }
                break;
            case SMALLEST_ALGE:
            {
                SortEigenvalue<Scalar, SMALLEST_ALGE> sorting(m_ritz_val.data(), (int)m_nev);
                ind = sorting.index();
            }
                break;
            case SMALLEST_MAGN:
            {
                SortEigenvalue<Scalar, SMALLEST_MAGN> sorting(m_ritz_val.data(), (int)m_nev);
                ind = sorting.index();
            }
                break;
            default:
