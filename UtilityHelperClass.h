...
{
public:
	static ProError ProUtiGeomitemFromFeature(ProFeature *feature_axis, ProType type, int  *featid);
	...
	static ProError ProUtilModelitemNameGet(ProModelitem* modelitem, std::string& name);
