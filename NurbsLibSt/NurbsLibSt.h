...
extern "C++" {
	...
	DECLSPEC void Mult(const CDoubleMatrix& matr, const CPointEx3DVector& vec, CPointEx3DVector& res, BOOL bOMP = false);

	// OMP implementation of Mult
	DECLSPEC void Mult_omp(const CDoubleMatrix& matr, const CPointEx3DVector& vec, CPointEx3DVector& res);
