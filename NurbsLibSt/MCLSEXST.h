...
inline int MsgBoxError(const std::string& str)
{
	return ::MessageBox(0, (LPCSTR)str.c_str(), (LPCSTR)"Error", MB_OK | MB_ICONERROR);
}

inline int MsgBoxQuestion(const std::string& str)
{
	return ::MessageBox(0, (LPCSTR)str.c_str(), (LPCSTR)"Question", MB_OKCANCEL | MB_ICONQUESTION);
}

inline int MsgBoxInfo(const std::string& str)
{
	return ::MessageBox(0, (LPCSTR)str.c_str(), (LPCSTR)"Info", MB_OK | MB_ICONEXCLAMATION);
}
